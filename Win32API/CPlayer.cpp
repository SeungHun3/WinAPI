	...
	, m_iDir(1)
{
	...
	GetAnimator()->CreateAnimation(L"IDLE_RIGHT", pLeftTex, Vec2(0.f, 0.f), Vec2(45.f, 50.f), Vec2(47.f, 0.f), 2.f, 2);
	GetAnimator()->CreateAnimation(L"IDLE_LEFT", pRightTex, Vec2(555.f, 0.f), Vec2(45.f, 50.f), Vec2(-47.f, 0.f), 2.f, 2);
